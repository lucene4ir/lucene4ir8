...
public class TRECCCDocumentIndexer extends DocumentIndexer {
    ...
    public TRECCCDocumentIndexer(String indexPath, String tokenFilterFile, boolean positional) {
    ...
    private void initFields() {
        ...
        if (indexPositions) {
            ...
            textField = new TextField(Lucene4IRConstants.FIELD_BODY, "", Field.Store.YES);
